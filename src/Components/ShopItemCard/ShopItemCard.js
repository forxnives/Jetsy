            ...
            <div className='shop-item-div'>
                ...
                <div className="shop-item__image">
                    ...
                    <div className={btnHovered ? 'img img-hover' : 'img'}>
                        ...
                        {/* <div onMouseEnter={() => setBtnHovered(true)} onMouseLeave={()=> setBtnHovered(false)} className="shop-item__cart svg-heart">
                        ...
                        <div onMouseEnter={() => setBtnHovered(true)} onMouseLeave={()=> setBtnHovered(false)} onClick={()=> addToCart(item)} className="shop-item__cart">
