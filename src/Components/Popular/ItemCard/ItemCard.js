...
const ItemCard = (props) => {
    ...
    const { item, addToCart, currentUser } = props;
            ...
            <div>
                ...
                <div className="item__image">
                    ...
                    <div className={btnHovered ? 'img img-hover' : 'img'}>
                        ...
                        <div onMouseEnter={() => setBtnHovered(true)} onMouseLeave={()=> setBtnHovered(false)} onClick={()=> handleAddToCart(item)} className="item__cart">
